...
def save_qualifying_loans(qualifying_loans):
    ...
    # write qualifying loans data to csv file, adding each loan to a new row
    with open(loan_save_path,'w',newline='') as loans_csv:
        loanwriter= csv.writer(loans_csv, delimiter=' ')
        len_list= len(qualifying_loans)
        i=0
        while i!= len_list:
            loanwriter.writerow(qualifying_loans[i:i+1])
            i+=1
